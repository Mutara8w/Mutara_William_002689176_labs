...
import ecosystem.Organization.PHDOrganization;
...
public class LabAssistantWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private PHDOrganization labOrganization;
    ...
    public LabAssistantWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, EcoSystem business) {
        ...
        this.labOrganization = (PHDOrganization) organization;
    ...
    public void populateTable() {
        ...
        for (WorkRequest request : labOrganization.getWorkQueue().getWorkRequestList()) {
            ...
            row[0] = request;
            row[1] = request.getSender().getEmployeeName().getEmployeeName();
            row[2] = request.getReceiver() == null ? null : request.getReceiver().getEmployeeName().getEmployeeName();
