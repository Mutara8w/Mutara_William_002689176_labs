...
public class BrowseProductsJPanel extends javax.swing.JPanel {
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Please check the modified quantity fields first");
            return;
        }
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Please check the price and quantity fields first");
            return;
        }

        if (salesPrice < product.getPrice()) {
            JOptionPane.showMessageDialog(this, "Quantity should be more than available");
            return;
        }
    ...
    private void populateCartTable() {
        ...
        for (OrderItem oi : currentOrder.getItemList()) {
